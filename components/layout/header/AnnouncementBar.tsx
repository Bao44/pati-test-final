...
export default function AnnouncementBar() {
  return (
    <div className="top-0 bg-(--color-brand-primary) text-white text-xs md:text-sm cursor-pointer">
      <div className="mx-auto flex max-w-full items-center justify-between px-14 max-sm:px-4 pt-2 pb-3">
        <div className="mx-auto tracking-wide font-semibold max-sm:text-center max-sm:text-[14px]">
          2026 STARTS NOW:{" "}
